            ...
            <div class="notice_dtl_footer">
                ...
                <div class="nd_footer_pre_next">
                    <ul class="nd_footer_next">
                        ...
                        <c:if test="${notice.nextNotice_code ne 0}"></c:if>
                        <a href="notice-dtl?code=${notice.nextNotice_code }"><li>${notice.nextNotice_title }</a></li>
                    </ul>
                    <ul class="nd_footer_pre">
                        <li class="pre_title">이전 글</li>
                        <c:if test="${notice.preNotice_code ne 0}"></c:if>
                        <a href="notice-dtl?code=${notice.preNotice_code }"><li>${notice.preNotice_title }</a></li>
                    </ul>
                </div>
            </div>
        </main>
