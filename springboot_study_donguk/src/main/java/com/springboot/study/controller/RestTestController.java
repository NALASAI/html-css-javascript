...
public class RestTestController {
	...
	@DeleteMapping("delete-req/{border}/{code}")  // 삭제
	public String deleteMapping(@PathVariable String border, @PathVariable String code) {
		return "delete";
	}
